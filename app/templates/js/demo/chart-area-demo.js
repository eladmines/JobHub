  ...
  var myLineChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        pointHitRadius: 10,
        pointBorderWidth: 2,
        data: [arrCount[0][1], arrCount[1][1], arrCount[2][1], arrCount[3][1], arrCount[4][1], arrCount[5][1], arrCount[6][1], arrCount[7][1], arrCount[8][1], arrCount[9][1], arrCount[10][1], arrCount[11][1]],
      }],
    },
    options: {
